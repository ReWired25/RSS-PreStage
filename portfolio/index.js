console.log(`Выполненная самооценка таска Portfolio #1:
...
PS: Если скрипт подсчёта семантических тегов некорректно отрабатывает, попробуйте обновить страницу с помощью ctrl+F5 и запустить скрипт в консоли снова.`);